...
begin
    ...
    values
    ('King Size Bed', 'A room with a king-size bad and a window', 100),
    ('Two Queen Size Beds', 'A room with two a queen-size bad and a window', 135),
    ('Executive Suite', 'Two rooms each with king-size bad and a window', 205);
end
